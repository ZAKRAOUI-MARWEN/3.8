...
public class LwM2mTransportServerHelper {
    ...
    public void sendParametersOnSobeamTelemetry(List<TransportProtos.KeyValueProto> kvList, SessionInfoProto sessionInfo, @Nullable Map<String, AtomicLong> keyTsLatestMaps){
        sendParametersOnSobeamTelemetry(kvList, sessionInfo, keyTsLatestMaps, null);
    }

    public void sendParametersOnSobeamTelemetry(List<TransportProtos.KeyValueProto> kvList, SessionInfoProto sessionInfo, @Nullable Map<String, AtomicLong> keyTsLatestMap, @Nullable Instant ts) {
