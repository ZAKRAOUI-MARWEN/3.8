...
import org.sobeam.server.common.msg.tools.MaxPayloadSizeExceededException;
...
public class SobeamErrorResponseHandler extends ResponseEntityExceptionHandler implements AccessDeniedHandler, ErrorController {
    ...
    static {
        ...
        errorCodeToStatusMap.put(SobeamErrorCode.VERSION_CONFLICT, HttpStatus.CONFLICT);
    }
    ...
    private void handleMaxPayloadSizeExceededException(HttpServletResponse response, MaxPayloadSizeExceededException exception) throws IOException {
        ...
        JacksonUtil.writeValue(response.getWriter(),
                SobeamErrorResponse.of(exception.getMessage(),
                        SobeamErrorCode.BAD_REQUEST_PARAMS, HttpStatus.PAYLOAD_TOO_LARGE));
    }
