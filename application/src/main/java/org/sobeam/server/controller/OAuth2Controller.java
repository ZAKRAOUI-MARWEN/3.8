...
import org.sobeam.server.service.entitiy.oauth2client.TbOauth2ClientService;
...
public class OAuth2Controller extends BaseController {
    ...
    public List<OAuth2ClientInfo> findTenantOAuth2ClientInfosByIds(
            ...
            @RequestParam("clientIds") UUID[] clientIds) throws SobeamException {
    ...
    public OAuth2Client getOAuth2ClientById(@PathVariable UUID id) throws SobeamException {
