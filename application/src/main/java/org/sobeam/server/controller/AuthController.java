...
import org.sobeam.server.dao.settings.SecuritySettingsService;
import org.sobeam.server.queue.util.TbCoreComponent;
import org.sobeam.server.service.security.auth.rest.RestAuthenticationDetails;
import org.sobeam.server.service.security.model.ActivateUserRequest;
import org.sobeam.server.service.security.model.ChangePasswordRequest;
import org.sobeam.server.service.security.model.ResetPasswordEmailRequest;
import org.sobeam.server.service.security.model.ResetPasswordRequest;
...
public class AuthController extends BaseController {
    ...
    public User getUser() throws SobeamException {
    ...
    public JwtPair resetPassword(@Parameter(description = "Reset password request.")
        ...
        if (userCredentials != null) {
            if (userCredentials.isResetTokenExpired()) {
                throw new SobeamException("Password reset token expired", SobeamErrorCode.BAD_REQUEST_PARAMS);
            }
