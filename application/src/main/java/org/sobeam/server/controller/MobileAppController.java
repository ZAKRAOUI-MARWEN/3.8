...
import org.sobeam.server.service.entitiy.mobile.TbMobileAppService;
...
public class MobileAppController extends BaseController {
    ...
    public MobileAppInfo getMobileAppInfoById(@PathVariable UUID id) throws SobeamException {
        MobileAppId mobileAppId = new MobileAppId(id);
