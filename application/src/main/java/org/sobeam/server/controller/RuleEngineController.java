...
import org.sobeam.server.service.ruleengine.RuleEngineCallService;
...
public class RuleEngineController extends BaseController {
    ...
    public DeferredResult<ResponseEntity> handleRuleEngineRequest(
        ...
        try {
            ...
            throw new SobeamException("Invalid request body", iae, SobeamErrorCode.BAD_REQUEST_PARAMS);
        }
    }
