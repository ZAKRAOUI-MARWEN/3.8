...
import org.sobeam.server.common.data.widget.WidgetTypeFilter;
import org.sobeam.server.common.data.widget.WidgetTypeInfo;
import org.sobeam.server.common.data.widget.WidgetsBundle;
import org.sobeam.server.common.data.widget.WidgetsBundleFilter;
...
public class WidgetTypeController extends AutoCommitController {
    ...
    public PageData<WidgetTypeInfo> getWidgetTypes(
            ...
            @RequestParam(required = false) Boolean scadaFirst) throws SobeamException {
