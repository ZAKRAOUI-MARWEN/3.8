...
public class EntityRelationController extends BaseController {
    ...
    private EntityRelation doSave(EntityRelation relation) throws SobeamException {
    ...
    private EntityRelation doDelete(String strFromId, String strFromType, String strRelationType, String strRelationTypeGroup, String strToId, String strToType) throws SobeamException {
