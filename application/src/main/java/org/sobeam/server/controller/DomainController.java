...
import org.sobeam.server.service.entitiy.domain.TbDomainService;
...
public class DomainController extends BaseController {
    ...
    public void updateOauth2Clients(@PathVariable UUID id,
                                    @RequestBody UUID[] clientIds) throws SobeamException {
    ...
    public DomainInfo getDomainInfoById(@PathVariable UUID id) throws SobeamException {
        DomainId domainId = new DomainId(id);
