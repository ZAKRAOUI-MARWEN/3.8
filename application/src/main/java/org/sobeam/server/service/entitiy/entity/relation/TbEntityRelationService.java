...
public interface TbEntityRelationService {
    ...
    EntityRelation save(TenantId tenantId, CustomerId customerId, EntityRelation entity, User user) throws SobeamException;

    EntityRelation delete(TenantId tenantId, CustomerId customerId, EntityRelation entity, User user) throws SobeamException;
