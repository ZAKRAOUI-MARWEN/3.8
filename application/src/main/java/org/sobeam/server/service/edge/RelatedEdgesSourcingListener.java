...
import org.sobeam.server.dao.edge.RelatedEdgesService;
...
public class RelatedEdgesSourcingListener {
    ...
    public void init() {
        ...
        executorService = Executors.newSingleThreadExecutor(SoBeamThreadFactory.forName("related-edges-listener"));
    }
