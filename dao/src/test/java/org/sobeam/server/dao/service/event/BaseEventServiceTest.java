...
public abstract class BaseEventServiceTest extends AbstractServiceTest {
    ...
    public void before() throws ParseException {
        timeBeforeStartTime = ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.parse("2024-11-01T11:30:00Z").getTime();
        startTime = ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.parse("2024-11-01T12:00:00Z").getTime();
        eventTime = ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.parse("2024-11-01T12:30:00Z").getTime();
        endTime = ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.parse("2024-11-01T13:00:00Z").getTime();
        timeAfterEndTime = ISO_8601_EXTENDED_DATETIME_TIME_ZONE_FORMAT.parse("2024-11-01T13:30:30Z").getTime();
    }
